        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="animate-fade-in-up">
            <h2
              ...
              className="text-3xl sm:text-4xl lg:text-[56px] font-bold text-[#1F2937] leading-[1.2] tracking-tight"
            >
              Voted &ldquo;Best of Business Rate 2025!&rdquo;
            </h2>
            <p
              data-testid="awards-subtitle"
              className="mt-4 text-xl sm:text-2xl lg:text-[32px] font-semibold text-[#1F2937] leading-snug"
            >
