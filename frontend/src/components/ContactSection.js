...
export default function ContactSection() {
  ...
  return (
    <section
      ...
      className="bg-[#334155] py-16 md:py-20"
      ...
      <div className="max-w-[1200px] mx-auto px-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="text-center lg:text-left animate-fade-in-up">
            ...
            <p className="mt-4 text-base text-white/80 leading-relaxed max-w-md mx-auto lg:mx-0">
              Contact us here at Pinoy General Insurance Services today for all
              your insurance needs.
            </p>

            {/* Contact Details */}
            <div className="mt-8 space-y-4 inline-flex flex-col items-start">
              <a
          ...
          <div className="text-center lg:text-left animate-fade-in-up delay-200">
            ...
            >
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center rounded-full bg-[#2563EB] px-8 py-3.5 text-base font-semibold text-white transition-all hover:bg-[#1D4ED8] hover:scale-[1.02] active:scale-[0.98]"
              >
                Get a Quote
              </button>
            </form>
            ...
            <div className="mt-6 flex justify-center lg:justify-start">
              <img
                ...
                className="max-w-[200px] rounded-2xl bg-white p-3 !shadow-xl"
              />
            </div>
          </div>
        </div>
        ...
        >
          <p className="text-sm text-white/60 text-center">
            &copy; 2025 Pinoy General Insurance Services. All rights reserved.
          </p>
        </footer>
      </div>
    </section>
